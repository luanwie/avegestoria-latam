        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <article className="flex-1 min-w-0">
            <div className="mb-10">
              ...
              <p className="text-sm text-stone-400 leading-relaxed">{post.description}</p>
            </div>
          ...
          <aside className="lg:w-72 shrink-0">
            <div className="lg:sticky lg:top-24 space-y-4">
              <div className="bg-brand-green/20 border border-brand-green/30 rounded-xl p-5">
                <p className="text-sm font-bold text-stone-100 mb-2">¿Listo para tener control total?</p>
                <p className="text-xs text-stone-400 leading-relaxed mb-4">
                  Prueba AveGestoria 7 días gratis. Sin compromiso. Sin tarjeta por adelantado.
                </p>
                <Link href="/es/prices" className="block text-center bg-brand-gold hover:bg-brand-gold-light text-brand-green-deeper font-bold px-4 py-2.5 rounded-xl text-xs transition-all">
                  Comenzar gratis →
                </Link>
              </div>
              <div className="bg-brand-gold/10 border border-brand-gold/20 rounded-xl p-5">
                <p className="text-xs text-stone-300 font-medium mb-1 flex items-center gap-1.5">
                  <MessageCircle className="w-3.5 h-3.5 text-brand-gold" /> ¿Prefieres hablar?
                </p>
                <p className="text-[10px] text-stone-500 mb-3">
                  Escríbeme por WhatsApp. Te respondo personalmente.
                </p>
                <a href="https://wa.me/5551993612092" target="_blank" rel="noopener noreferrer"
